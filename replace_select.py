...
old = '''        JButton selectColumnsBtn = new JButton("Select Columns");
...
new = '''        JButton selectColumnsBtn = new JButton("Select Columns");
        selectColumnsBtn.setMargin(new Insets(2, 8, 2, 8));
...
if old in content:
    ...
    if "columnSelectPanel" in content:
        print("Found columnSelectPanel - old code still there")
    else:
        print("columnSelectPanel not found")
